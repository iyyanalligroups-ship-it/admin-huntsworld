  ...
  return (
    <div className="bg-white text-black py-10 px-5 lg:px-20">
      ...
      <p className="text-gray-700 mb-8">
        These Terms and Conditions (“Terms”) constitute a legally binding agreement between you (“User,” “you,” or “your”) and Huntsworld Digital Pvt Ltd (“Huntsworld,” “we,” “us,” or “our”) governing your access to and use of the Huntsworld B2B marketplace platform, including our website (www.huntsworld.com), mobile applications, and related services (collectively, the “Platform”). By accessing or using the Platform, you acknowledge that you have read, understood, and agree to be bound by these Terms. If you do not agree, you must not use the Platform.
      </p>
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-700">
          ...
          Registered Address: [Insert Registered Office Address Here]<br />
          Email: <a href="mailto:legal@huntsworld.com" className="text-[#E33831] hover:underline">legal@huntsworld.com</a><br />
          Grievance Officer: <a href="mailto:grievance@huntsworld.com" className="text-[#E33831] hover:underline">grievance@huntsworld.com</a><br />
          Support: <a href="mailto:support@huntsworld.com" className="text-[#E33831] hover:underline">support@huntsworld.com</a><br />
