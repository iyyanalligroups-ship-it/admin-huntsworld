...
const contactUsData = [
    ...
    content: (
      <>
        ...
        <p className="text-gray-600 mb-6">
          Having Questions? Tell us about your Business. Our experts will check all the aspects and call you back to explain how <span className="font-bold text-[#E33831]">exportersindia.com</span> would help you to get quotes for your Business.
        </p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <a href="#" className="text-xl text-[#E33831] mb-2">ExportersIndia.com</a>
        <p className="text-gray-700">C/o Weblink.In Pvt. Ltd.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <div className="mt-4">
        <div className="flex items-center gap-2">
          ...
          <p><strong>Sales:</strong> +91-9953717914</p>
        </div>
        <div className="flex items-center gap-2 mt-2">
          <Phone className="w-5 h-5 text-[#E33831]" />
          <p><strong>Support:</strong> +91-9700318318</p>
        </div>
      </div>
    ),
  },
    ...
    content: (
      <div className="mt-4">
        <div className="flex items-center gap-2">
          ...
          <a href="mailto:feedback@exportersindia.com" className="text-[#E33831] underline">
            feedback@exportersindia.com
          </a>
        </div>
      </div>
    ),
