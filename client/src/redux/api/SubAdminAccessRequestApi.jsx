...
export const SubAdminAccessRequestApi = createApi({
  ...
  getAccessRequests: builder.query({
            query: ({ page, limit, status }) =>
                `/subAdmin-request-access/fetch-request?page=${page}&limit=${limit}&status=${status}`,
    ...
    getAccessRequestDetails: builder.query({
      query: (requestId) => `/subAdmin-request-access/notifications/access-requests/${requestId}`,
     providesTags: ['AccessRequests'],
    }),
  }),
});
