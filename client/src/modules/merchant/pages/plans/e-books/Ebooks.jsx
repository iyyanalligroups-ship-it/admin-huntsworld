  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-6 shadow-lg">
              <CardHeader>
                <CardTitle className="text-2xl font-bold text-red-600 font-montserrat flex items-center">
                  <MapPin className="mr-2 h-6 w-6" />
                  {companyDetails.company_name}
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600 italic font-roboto">{companyDetails.description}</p>
                <p className="text-gray-700 mt-4 font-roboto flex items-center">
                  <User className="mr-2 h-4 w-4" />
                  {companyDetails.company_email}
                </p>
                <p className="text-gray-700 mt-2 font-roboto flex items-center">
          ...
          <div className="lg:col-span-3">
              ...
              <DialogContent>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Button onClick={handleAddCity} className="mt-2" disabled={!currentCity}>
                      Add City
                    </Button>
                  </div>
                  <div>
            ...
            {/* Competitor Cards */}
            {isLoading ? (
              <p className="text-gray-600 font-roboto">Loading competitors...</p>
              ...
              competitorData.competitors.map(({ city, merchant, address, user, products, merchant_id }) => (
                <Card key={merchant_id} className="mb-6 shadow-lg">
                  <CardHeader>
                    <CardTitle className="text-xl font-semibold text-gray-800 font-montserrat flex items-center">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div>
                        <p className="text-gray-600 font-roboto flex items-center">
                          <User className="mr-2 h-4 w-4" />
                          <span className="font-medium">Owner:</span> {user?.name} ({user?.email}) ({user?.phone})
                        </p>
                        <p className="text-gray-600 font-roboto flex items-center mt-1">
                          <Mail className="mr-2 h-4 w-4" />
                          <span className="font-medium">Email:</span> {merchant.company_email}
                        </p>
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 font-roboto">{address.address_line_1}</p>
                        {address.address_line_2 && (
                          <p className="text-gray-600 font-roboto">{address.address_line_2}</p>
                        )}
                      ...
                      <div>
                        ...
                        {products.length > 0 ? (
                          <ul className="list-none text-gray-600 font-roboto mt-2">
                            {products.map((product, i) => (
                              <li key={i} className="border-l-2 border-red-600 pl-3 mb-2">
                                {product}
                              </li>
                            ))}
                          </ul>
                        ) : (
                          <p className="text-gray-600 font-roboto">No products available.</p>
                        )}
                      </div>
                    </div>
                  </CardContent>
              ...
              <p className="text-gray-600 font-roboto">No competitor data available.</p>
            )}
            ...
            {competitorData?.hasMore && (
              <Button
                onClick={loadMore}
                className="mt-6 bg-blue-600 hover:bg-blue-700 text-white w-full lg:w-auto"
              >
                Load More
              </Button>
            )}
        ...
        {/* Footer */}
        <div className="text-center text-sm text-gray-600 font-roboto mt-8">
