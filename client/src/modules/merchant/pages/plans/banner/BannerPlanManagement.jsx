...
const BannerPlanManagement = ({ user, hasSubscription, subscriptionId, activeBannerPayment, pendingBannerPayment, onRefresh, setIsBannerDetailsOpen }) => {
        ...
        handler: async (response) => {
          try {
            ...
            if (verifyRes.success) {
              toast.success(`Payment for ${days} days (₹${amount}) completed. Please upload banner details.`);
      ...
      const options = {
        ...
        handler: async (response) => {
          try {
            ...
            if (verifyRes.success) {
              toast.success(`Upgraded banner for ${days} days for ₹${amount}`);
              setIsBannerDetailsOpen(true);
          await onRefresh();
            } else {
              toast.error('Payment verification failed');
