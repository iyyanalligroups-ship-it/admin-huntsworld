...
const ComplaintForm = ({ onCancel }) => {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <h2 className="text-xl font-bold mb-4 border-b-2">Add Complaint</h2>
      <Card>
        <CardHeader>
          <CardTitle>
          ...
          {selectedOption && (
            <>
              ...
              <div className="flex gap-4 mt-4">
                <Button className="bg-[#e03733] w-full" onClick={handleSubmit}>
                  {isEditMode ? "Update Complaint" : "Submit Complaint"}
                </Button>
                <Button className="bg-gray-500 w-full" onClick={onCancel}>
                  Cancel
                </Button>
              </div>
