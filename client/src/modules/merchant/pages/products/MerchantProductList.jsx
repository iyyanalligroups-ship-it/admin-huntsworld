...
import StepperProductForm from "./MerchantProductForm"; // Import the form component
...
const MerchantProductListing = () => {
  ...
  // });
  const { data: data } = useGetUserSellerProductsByIdQuery(
    { userId, page: 1, limit: 10, filter: "", search: "" },
    { skip: !userId }
  );
  ...
  return (
    <div className="p-6 space-y-6 max-w-2xl mx-auto">
      {/* Conditionally render the form based on mode */}
      {formMode && (
        <StepperProductForm
