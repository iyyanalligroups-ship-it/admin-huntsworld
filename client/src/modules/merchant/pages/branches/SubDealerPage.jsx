...
const SubDealerPage = () => {
  ...
  const handleEdit = (subDealer) => {
    setFormData({
      ...
      company_type: subDealer.company_type?.name || subDealer.company_type || '',
  ...
  return (
    <div className={`${isSidebarOpen ? 'p-6 lg:ml-56' : 'p-4 lg:ml-16'} transition-all duration-300`}>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-2xl font-bold mb-6 text-[#0c1f4d]">
        ...
        <Card className="mt-8">
          <CardHeader>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button onClick={handleCreateNew}>Create New Sub Dealer</Button>
            </div>
          </CardHeader>
          <CardContent>
