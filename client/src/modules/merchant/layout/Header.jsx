...
import PhoneNumberAccessNotificationBell from "../utils/PhoneNumberAccessNotificationBell";
    ...
    >
      <div className="flex items-center justify-between px-4 py-2 gap-3">
        ...
        <div className="flex items-center gap-4">
          <NotificationBell />
          <PhoneNumberAccessNotificationBell userId={userId} />
          <button onClick={() => navigate("/merchant/chat")}>
