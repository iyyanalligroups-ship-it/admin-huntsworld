...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <div
        className={`fixed top-0 left-0 h-full  backdrop-blur-md shadow-2xl border transition-all duration-300 z-10 bg-[#0c1f4d] ${
      ...
      >
        ...
        <div className="flex items-center p-2 border-b-1 ">
          ...
          <img src={easyCol} className={`w-32 ml-6 cursor-pointer ${!isSidebarOpen ? "hidden" : ""}`}   onClick={() => navigate("/merchant")}/>
        </div>
