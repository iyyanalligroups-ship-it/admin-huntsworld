                    ...
                    <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                        ...
                        <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
                            ...
                            <DialogContent>
                                ...
                                <div className="py-4">
                                    <Input
                                        placeholder="e.g. Gold Member, Senior Citizen"
                                        value={newName}
                                ...
                                <DialogFooter>
                                    ...
                                    <Button className="cursor-pointer bg-[#153171] text-white hover:bg-[#153171eb]" onClick={handleAdd}>Create</Button>
                                </DialogFooter>
                            </DialogContent>
                        </Dialog>
                    </div>
            ...
            <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
                <DialogContent>
                    ...
                    <DialogFooter>
                        ...
                        <Button onClick={handleEdit} className="cursor-pointer bg-[#153171] text-white hover:bg-[#153171eb]">Save Changes</Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
                ...
                <AlertDialogContent>
                    ...
                    <AlertDialogFooter>
                        ...
                        <AlertDialogAction
                            ...
                            className="bg-[#153171] text-white hover:bg-[#153171eb]"
                        >
                            Delete
                        </AlertDialogAction>
                    </AlertDialogFooter>
