                ...
                <form onSubmit={handleSave} className="grid gap-5 sm:gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Instagram, TikTok, Threads..."
                            required
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-10 pr-12 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none text-base"
                                autoComplete="off"
                                spellCheck={false}
                            />
                            ...
                            <div className="absolute right-1 top-1/2 -translate-y-1/2">
                                ...
                                >
                                    <SelectTrigger className="border-0 shadow-none bg-transparent hover:bg-gray-100 focus:ring-0 p-1.5 h-9 w-9 flex items-center justify-center rounded-md">
