...
const TrustSealCertificate = ({
  ...
  const formattedIssueDate = issueDate ? format(new Date(issueDate), "do MMMM yyyy") : "-";
  const formattedExpiryDate = expiryDate ? format(new Date(expiryDate), "do MMMM yyyy") : "-";
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", backgroundColor: "#f4f4f5", padding: "24px", minHeight: "100%" }}>
