...
const Stepper3 = ({ formData, setFormData, error, setError, handleNext, handleBack }) => {
  ...
  const validateForm = () => {
    ...
    if (
      ...
      const msg = "All fields are required, and description must be 10–3000 words.";
      setError(msg);
      showToast(msg, "error");
      return false;
    }
    ...
    if (formData.company_email) {
      ...
      if (!emailRegex.test(formData.company_email)) {
        const msg = "Please enter a valid company email.";
        setError(msg);
        showToast(msg, "error");
        return false;
      }
    ...
    <div className="max-w-7xl w-full max-h-[100vh] overflow-y-auto overflow-x-hidden space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-4">
          ...
          <div>
            <Label htmlFor="company_email">Company Email <span className="text-gray-400 text-xs font-normal">(optional)</span></Label>
            <Input
              id="company_email"
              name="company_email"
              type="email"
      ...
      <div>
        ...
        <Textarea
          ...
          onChange={handleInputChange}
          placeholder="Enter company description (minimum 10 words)"
        ...
        <p className="text-sm text-gray-500">
          ...
          {formData.description && !isDescriptionValid && (
            <span className="text-red-500"> (Must be 10–3000 words)</span>
          )}
        </p>
      </div>
