...
console.log(selectedMerchant,"serv");
  ...
  return (
  <>
      <h2 className="text-md border-1 border-[#0c1f4d] text-[#153171] bg-gray-100 p-2 rounded-r-2xl font-bold w-fit mb-3">Add Product : </h2>
  ...
  {["Category", "Basic Info", "Attributes"].map((label, index) => (
    <div
      key={index}
      className={`min-w-[130px] flex-1 text-center py-2 border-b-2 ${
        step === index + 1
