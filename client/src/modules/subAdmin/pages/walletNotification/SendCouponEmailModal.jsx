        ...
        <div className="p-6 space-y-6">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="border-gray-200 focus:border-[#0c1f4d] focus:ring-[#0c1f4d] h-11"
            />
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              placeholder="Provide details on how to use this coupon..."
              value={description}
              onChange={(e) => setDescription(e.target.value)}
              className="border-gray-200 focus:border-[#0c1f4d] focus:ring-[#0c1f4d] min-h-[120px] resize-none"
            />
          </div>
