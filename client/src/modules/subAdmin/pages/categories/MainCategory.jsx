    ...
    <div className={`${isSidebarOpen ? "p-6 lg:ml-56" : "p-4 lg:ml-16"}`}>
      <div className="max-w-6xl w-full mx-auto mt-10">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-md border-1 border-[#0c1f4d] text-[#153171] bg-gray-100 p-2 rounded-r-2xl font-bold">Manage Categories</h2>
          <Button variant="default" className="bg-[#0c1f4d] cursor-pointer group-hover:bg-[#0c204de2]" onClick={() => setModalOpen(true)}>
            + Add Category
          </Button>
        </div>
