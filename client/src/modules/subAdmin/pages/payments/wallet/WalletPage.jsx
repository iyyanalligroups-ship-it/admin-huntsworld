...
import { Wallet, ArrowLeft, Banknote, ShieldAlert } from 'lucide-react';
  ...
  return (
    <div className="p-4 md:p-8">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-md border-1 w-fit mb-3 border-[#0c1f4d] text-[#0c1f4d] bg-gray-100 p-2 rounded-r-2xl font-bold">Sub-Admin Wallet Management</h2>
              ...
              {isLoading ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex flex-col md:flex-row items-stretch md:items-center gap-4">
                    ...
                    <Button
                      className="md:w-64 h-full cursor-pointer bg-[#0c1f4d] hover:bg-[#0c204d] text-white font-bold text-sm py-8 rounded-2xl shadow-lg transition-all transform hover:-translate-y-1 active:scale-95 disabled:opacity-50 disabled:grayscale disabled:cursor-not-allowed group"
            ...
            <div className="p-4">
              {selectionMode === 'choice' ? (
                <div className="grid grid-cols-2 gap-4 py-4 animate-in fade-in slide-in-from-top-4 duration-500">
                  <Button
                    variant="outline"
                    className="h-40 flex flex-col gap-3 border-2 border-gray-100 hover:border-green-500 hover:bg-green-50 rounded-2xl transition-all group shadow-sm"
                  ...
                  <Button
                    variant="outline"
                    className="h-40 flex flex-col gap-3 border-2 border-gray-100 hover:border-blue-500 hover:bg-blue-50 rounded-2xl transition-all group shadow-sm"
                ...
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                  {selectedSeller?.role === 'STUDENT' && (
                    <Button
                      ...
                      className="mb-6 text-blue-600 bg-blue-50 hover:bg-blue-100 flex gap-2 items-center rounded-full px-4 font-bold text-xs"
                    >
