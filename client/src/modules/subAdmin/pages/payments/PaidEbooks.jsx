...
const PaidEbooks = () => {
  ...
  const { user: adminUser } = useContext(AuthContext); // admin user
  ...
  }, [selectedSeller?._id, adminUser.token]);
  ...
  useEffect(() => {
    ...
    fetchFreeCities();
  }, [activeEbookPayments?.data, isEbookPaymentsLoading, adminUser.token]);
  ...
  return (
    <div className={`${isSidebarOpen ? "lg:p-6 lg:ml-56" : "lg:p-4 lg:ml-16"}`}>
          ...
          <>
            ...
            <div className="mb-6">
              <Button
                ...
                className="bg-[#0c1f4d] hover:bg-[#0c1f4d]/90"
      ...
      <DeleteDialog
        ...
        onDelete={confirmCancelEbook}
        title="Cancel E-Book Access"
        description="Are you sure you want to cancel this merchant's e-book access? This will remove all their unlocked paid extra cities."
      />
    </div>
  );
};
