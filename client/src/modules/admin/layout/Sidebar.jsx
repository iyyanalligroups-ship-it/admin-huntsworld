...
const Sidebar = () => {
  ...
  const getUnreadBadge = (item) => {
    ...
    if (title === "Users") {
    ...
    } else if (title === "Others" && link === "/admin-dashboard/other-products") {
      ...
      // NOTE: Checking the link ensures we map to Requests/Trust Seal, though maybe Payments/Trust Seal could also show it
