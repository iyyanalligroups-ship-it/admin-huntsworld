...
import {
  useGetPermissionRequestsMappingQuery, useMarkNotificationAsReadMutation,
...
export const NotificationProvider = ({ children }) => {
  ...
  const { data, isLoading, isError } = useGetPermissionRequestsMappingQuery({ filter: "all", adminId: userId });
