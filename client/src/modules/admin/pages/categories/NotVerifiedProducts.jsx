  ...
  return (
    <div className={`${isSidebarOpen ? "lg:p-6 lg:ml-56" : "lg:p-4 lg:ml-16"} transition-all duration-300`}>
      ...
      <Input
        ...
        className="mb-4 w-full max-w-md border-2 border-slate-300"
      />
            ...
            {products.map((product) => {
              ...
              return (
                <TableRow key={product._id}>
                  ...
                  {/* Actions */}
                  <TableCell className="py-1 flex gap-1 sm:gap-2">
                    <Tooltip>
                        <TooltipTrigger asChild>
                          <Button
                            variant="ghost"
                        ...
                        <TooltipContent side="top" sideOffset={4}>View Details</TooltipContent>
                      </Tooltip>
                      ...
                      {!product.markAsRead && (
                        <Tooltip>
                          ...
                          <TooltipContent side="top" sideOffset={4}>Mark as Read</TooltipContent>
                        </Tooltip>
                      )}
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent side="top" sideOffset={4}>Verify Product</TooltipContent>
                      </Tooltip>
                    </TableCell>
                </TableRow>
              );
              ...
              <div className="flex flex-wrap gap-2.5 pt-3 border-t mt-1">
                {!product.markAsRead && (
                  <Button
                    ...
                    size="sm"
                    onClick={() => handleMarkAsRead(product._id)}
                    className="flex-1 min-w-[88px] cursor-pointer justify-center text-sm"
                  >
                ...
                <Button
                  ...
                  size="sm"
                  onClick={() => handleDelete(product._id)}
                  className="flex-1 min-w-[88px] cursor-pointer justify-center border-red-200 text-red-600 hover:bg-red-50 text-sm"
                >
