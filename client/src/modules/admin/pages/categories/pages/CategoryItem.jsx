        ...
        <img
          src={
            category.categoryImage
              ? encodeURI(category.categoryImage)
              : noImage
          }
          width="100"
          height="100"
          ...
          onError={(e) => {
            console.error("Image failed to load:", category.categoryImage);
            e.target.src = noImage;
          }}
        />
      </div>
      <div className="flex gap-2 mt-2 sm:mt-0">
        <Button size="icon" variant="ghost" className="cursor-pointer" onClick={() => onEdit(category)}>
          <Pencil size={16} />
        </Button>
        <Button
          size="icon"
