    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="flex flex-col space-y-1.5 md:col-span-2">
          <Label htmlFor="address_line_1" className="text-sm font-semibold text-gray-700">
          ...
          <Input
            ...
            className={`h-11 border-2 border-slate-300 ${touched.address_line_1 && errors.address_line_1 ? "border-red-500 focus-visible:ring-red-500" : ""}`}
          />
        ...
        {/* Address Line 2 */}
        <div className="flex flex-col space-y-1.5 md:col-span-2">
          <Label htmlFor="address_line_2" className="text-sm font-semibold text-gray-700">
            Address Line 2 <span className="text-gray-400 font-normal">(Optional)</span>
          </Label>
          <Input
            id="address_line_2"
            name="address_line_2"
            placeholder="e.g. Apt, Suite, Building, etc."
        ...
        <div className="flex flex-col space-y-1.5">
          ...
          <Select onValueChange={handleCountryChange} value={selectedCountryCode}>
            <SelectTrigger className={`w-full h-11 border-2 border-slate-300 ${touched.country && errors.country ? "border-red-500" : ""}`}>
        ...
        <div className="flex flex-col space-y-1.5">
          ...
          <Select onValueChange={handleStateChange} value={selectedStateCode} disabled={!selectedCountryCode}>
            <SelectTrigger className={`w-full h-11 border-2 border-slate-300 ${touched.state && errors.state ? "border-red-500" : ""}`}>
        ...
        <div className="flex flex-col space-y-1.5">
          ...
          <Select onValueChange={handleCityChange} value={addressFormData.city} disabled={!selectedStateCode}>
            <SelectTrigger className={`w-full h-11 border-2 border-slate-300 ${touched.city && errors.city ? "border-red-500" : ""}`}>
        ...
        <div className="flex flex-col space-y-1.5">
          ...
          <Input
            ...
            onChange={handleInputChange}
            className={`h-11 border-2 border-slate-300 ${touched.pincode && errors.pincode ? "border-red-500 focus-visible:ring-red-500" : ""}`}
          />
        ...
        <div className="flex flex-col space-y-1.5">
          ...
          >
            <SelectTrigger className={`w-full h-11 border-2 border-slate-300 ${touched.entity_type && errors.entity_type ? "border-red-500" : ""}`}>
        ...
        <div className="flex flex-col space-y-1.5">
          ...
          >
            <SelectTrigger className={`w-full h-11 border-2 border-slate-300 ${touched.address_type && errors.address_type ? "border-red-500" : ""}`}>
