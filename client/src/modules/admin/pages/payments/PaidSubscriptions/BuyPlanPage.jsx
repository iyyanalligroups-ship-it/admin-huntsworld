...
const BuyPlanPage = () => {
  ...
  // 🟢 use currentData to ensure we only get results for the ACTUAL current term (fixes Mano/Anbu ghosting)
  ...
  return (
    <div className="flex-1 bg-slate-50 min-h-screen pb-24 transition-all">
      <div className="bg-slate-900 pb-32 pt-20 text-center relative overflow-hidden">
        ...
        <Badge className="mb-6 bg-indigo-500/20 text-indigo-300 border-indigo-500/30">Admin Control Panel</Badge>
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="pl-12 pr-10 h-14 rounded-2xl border-2 border-slate-300 focus:ring-2 focus:ring-indigo-500"
              />
              {searchInput && (
                <button
