  ...
  useEffect(() => {
    ...
    const handleMessageUpdated = (updatedMsg) => {
      ...
      if (isRelated && updatedMsg._id) {
        setMessages((prev) => {
          const messageExists = prev.some((m) => m._id === updatedMsg._id);
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        (isAutoRequirementCard || isAutoComplaintCard) ? "p-0 bg-transparent shadow-none border-none max-w-full" : ""
                      )}
                            ...
                            return (
                              <div className={cn(
                                ...
                                <div className={cn(
                                  ...
                                  {type === "pdf" ? <Ban size={20} className="rotate-45" /> : <MoreHorizontal size={20} />}
                                </div>
