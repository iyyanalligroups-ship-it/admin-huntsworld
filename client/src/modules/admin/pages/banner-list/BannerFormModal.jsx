          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={type} onValueChange={setType} disabled={!!editData}>
                <SelectTrigger id="type" className="w-full border-2 border-slate-300">
                  <SelectValue placeholder="e.g. Select type" />
                </SelectTrigger>
                <SelectContent>
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                type="url"
                className={`border-2 border-slate-300 ${linkError ? "border-red-500 focus-visible:ring-red-500" : ""}`}
              />
